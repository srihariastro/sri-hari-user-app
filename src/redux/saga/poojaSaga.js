...
import {
  ...
  get_new_pooja,
  get_pooja,
  get_puja_history_data,
  get_video_call_astrologer,
  ...
  try {
    ...
    if (poojaDataResponse?.success) {
      yield put({
        ...
        payload: poojaDataResponse?.pooja,
      });
    }
    yield put({type: actionTypes.SET_IS_LOADING, payload: true});
  } catch (e) {
...
export default function* poojaSaga() {
  ...
  yield takeLeading(
    actionTypes.GET_BOOK_POOJA_HISTORY_DATA,
    getBookPoojaHistoryData,
  );
}
