...
export const base_url = "https://api.srihariastro.com/";
export const img_url = "https://api.srihariastro.com/uploads/";
export const api_url = "https://api.srihariastro.com/api/";
...
export const book_pooja_order_create = 'customers/phonepe_payment_for_puja'
...
export const get_delete_cart = 'ecommerce/delete_address_cart';
export const get_update_cart = 'ecommerce/update_address_cart';
// numerology
