...
const NotesPageHeader = ({ selectedNotes, setSelectedNotes, setFilteredNotes, isSearchMode, setIsSearchMode, searchValue, setSearchValue,props }) => {
        ...
        <>
          {selectedNotes.length == 0 ? (
            <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingVertical: 5 }}>
              <Pressable style={{ padding: 5, marginRight: 5 }} onPress={() => props.navigation.goBack()}>
                <Icon name="arrow-back" size={24} />
              </Pressable>
              <Text allowFontScaling={false} style={{ fontSize: 20, color: "#333" }}>Notes</Text>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 10, paddingVertical: 5 }}>
              ...
              <Text allowFontScaling={false} style={{ marginLeft: 5, color: "#333", fontSize: 18 }}>{selectedNotes.length} selected</Text>
