          ...
          style={{
            ...
            elevation:6
              ...
              <View style={styles.itemContainer}>
                  <Text allowFontScaling={false} style={styles.itemText}>{props.kundliRashiReport.jupiterReports.planet}</Text>
                  <View>
                  <Text allowFontScaling={false} style={{ color: 'black', padding: 10, fontSize: getFontSize(1.8), textAlign: 'justify' }}>
                      {props.kundliRashiReport.jupiterReports.rashi_report}
                  </Text>
                  </View>
              </View>
              )}
