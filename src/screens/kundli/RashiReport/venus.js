          ...
          style={{
            ...
            elevation:6
              ...
              <View style={styles.itemContainer}>
                  <Text allowFontScaling={false} style={styles.itemText}>{props.kundliRashiReport.venusReports.planet}</Text>
                  <View>
...
export default connect(mapStateToProps, mapDispatchToProps)(venus);
